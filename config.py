...
myConfig = "/home/mawi/.config/qtile/config.py"    # The Qtile config file location
...
keys = [
         ...
         ### My applications launched with
         Key(
             [alt], "b",
             lazy.spawn("brave"),
             desc='Opens brave browser'
             ),
         Key(
             [alt], "f",
             lazy.spawn("vifm"),
...
floating_layout = layout.Floating(float_rules=[
    ...
    {'wname': 'branchdialog'},  # gitk {'wname': 'pinentry'},  # GPG key password entry
